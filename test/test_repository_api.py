...
class TestRepositoryApi(unittest.TestCase):
    ...
    def test_repo_change_files(self):
    ...
    def test_repo_delete_avatar(self):
    ...
    def test_repo_get_issue_config(self):
    ...
    def test_repo_list_activity_feeds(self):
    ...
    def test_repo_list_pinned_issues(self):
    ...
    def test_repo_list_pinned_pull_requests(self):
    ...
    def test_repo_new_pin_allowed(self):
    ...
    def test_repo_update_avatar(self):
    ...
    def test_repo_validate_issue_config(self):
